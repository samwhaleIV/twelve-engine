...
namespace ElfScript.VirtualMachine {
    internal sealed partial class VirtualMemory {
        ...
        private readonly TypeContainer<FunctionDeclaration> _functions = new();
        ...
        public void SetFunction(Address address,FunctionDeclaration value) => Set(address,value,Type.Function,_functions);
        ...
        public FunctionDeclaration GetFunction(Address address) => Get(address,Type.Function,_functions);
