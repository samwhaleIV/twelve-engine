namespace TwelveEngine.UI {
    ...
    /// </summary>
    internal readonly struct ButtonFocusNavState<TElement> where TElement : class {

        public readonly TElement PreviousFocusElement, CurrentFocusElement;
        public readonly Direction Direction;

        public ButtonFocusNavState(TElement previousFocusElement, TElement currentFocusElement, Direction direction) {
            PreviousFocusElement = previousFocusElement;
            CurrentFocusElement = currentFocusElement;
            Direction = direction;
        }

        public static readonly ButtonFocusNavState<TElement> None = new(null,null,Direction.None);
    }
}
