...
namespace John {
    public static class Constants {
        ...
        public const bool USE_CAM_BOUNDS = false;
        public const float CLAW_SPEED = 0.03f;
        ...
        public static readonly Vector2 GRABBY_CLAW_START_POS = new Vector2(15,4); //TODO: Set real value
        ...
        public static readonly Vector2[] JOHN_SPAWN_LOCATIONS = new Vector2[] { new Vector2(4.5f,0.5f),new Vector2(14.5f,0.5f),new Vector2(24.5f,0.5f) };

        public const int MAX_ARENA_JOHNS = 64;
        public const float REAL_JOHN_PROBABILITY = 0.1f;

        public static readonly TimeSpan JOHN_SUMMON_COOLDOWN = TimeSpan.FromSeconds(0.1f);
        public static readonly TimeSpan JOHN_SUMMON_VARIABILITY = TimeSpan.FromSeconds(0.5f);
        ...
        public const float WALKING_ANIMATION_VELOCITY_THRESHIOLD = 0.5f;

        public const float JOHN_EDGE_SWAP_MARGIN = 0.5f;
        public const float JOHN_EDGE_LIMIT = 1;
